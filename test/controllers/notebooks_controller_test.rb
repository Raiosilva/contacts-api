...
class NotebooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notebook" do
    assert_difference('Notebook.count') do
      post notebooks_url, params: { notebook: { birthdate: @notebook.birthdate, email: @notebook.email, name: @notebook.name } }, as: :json
    end
  ...
  test "should update notebook" do
    patch notebook_url(@notebook), params: { notebook: { birthdate: @notebook.birthdate, email: @notebook.email, name: @notebook.name } }, as: :json
    assert_response 200
  end
